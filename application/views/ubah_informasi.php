<html>
    ...
    <?php 
        if ($this->session->flashdata('verif_alert')=='verif_berhasil'){
            echo "<script>alert('Verifikasi password dan hint berhasil');</script>";
        }
    ?>
    <?php 
        if ($this->session->flashdata('update_alert')=='update_berhasil'){
            echo "<script>alert('Update Berhasil dilakukan');</script>";
        }
        else if($this->session->flashdata('update_alert')=='update_gagal'){
    ...
    <section>
        ...
        <section>
            <div class="container-fluid">
                <div class="row">
                    <div class="col-2"></div>
                    <div class="col-3 register">UBAH INFORMASI</div>
                </div>
                <div class="row">
                    <div class="col-2"></div>
                    <div class="col-8">
                        <div class="shadow-lg p-4 mb-4 bg-white">
                            <div class="row">
                                ...
                                <div class="col-10">
                                    <p>Anda dapat mengubah informasi profil data anda, jika ingin mengubah informasi dapat dilakukan pada menu di bawah ini dan klik "SAVE". Jika ingin merubah password, silahkan klik "ubah password" <a href="<?php echo base_url('index.php/webController/ubah_password') ?>">Ubah Password</a></p>
                                </div>
                            </div>
                            <div class="row">
                            <div class="col-1"></div>
                            <div class="col-10">
                            <form action="<?php echo base_url('index.php/webController/ubah_informasi_data')?>" method="post">
                                <div class="form-group">
                                    ...
                                    <div class="col-8">
                                        <input type="text" id="id" class="form-control"  name="id" value="<?php echo $this->session->userdata('id') ?>" readonly>
                                    </div>
                                    </div>
                                </div>                             
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-8">
                                        <input type="text" name="no_hp" class="form-control" value="<?php echo $this->session->userdata('no_hp') ?>" >
                                    </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-5"></div>
                                    <div class="col-3>"><button type="submit" class="btn btn-primary">UBAH INFORMASI</button></div>
                                </div>
                            </form>
                            </div>
                        </div>
