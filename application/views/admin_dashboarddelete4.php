                ...
                <tbody>
                    <tr><?php foreach ($event as $evn) : ?>
                        ...
                        <td class="text-center">
                            <a href="<?= base_url(); ?>index.php/adminController/dashboar_delete_data/<?= $evn['id'] ?>/event " class="badge badge-danger float-center" onclick="return confirm('Apakah anda yakin menghapus data ini?');" ?>hapus</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
