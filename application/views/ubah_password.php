<html>
    ...
    <?php 
        if ($this->session->flashdata('update_alert')=='update_berhasil'){
            ...
            echo "<script>alert('Password Lama Salah, atau password tidak sesuai');</script>";
        }
    ?>
    <?php
    ...
    <section>
        ...
        <section>
            <div class="container-fluid">
                <div class="row">
                    <div class="col-2"></div>
                    <div class="col-3 register">UBAH PASSWORD</div>
                </div>
                <div class="row">
                    <div class="col-2"></div>
                    <div class="col-8">
                        <div class="shadow-lg p-4 mb-4 bg-white">
                            ...
                            <div class="col-1"></div>
                            <div class="col-10">
                            <form action="<?php echo base_url('index.php/webController/ubah_password_data')?>" method="post">
                                <div class="form-group">
                                    ...
                                    <div class="col-8">
                                        <input type="password" id="passwordlama" onkeyup='check();' class="form-control"  name="passwordlama" required>
                                    </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-8">
                                        <input type="password" id="passwordbaru" onkeyup='check();' class="form-control"  name="passwordbaru" required>
                                    </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-8">
                                        <input type="password" id="konfirmasipassword" name="konfirmasipassword" onkeyup='check();' class="form-control"  required>
                                ...
                                <div class="row">
                                    <div class="col-5"></div>
                                    <div class="col-3>"><button type="submit" class="btn btn-primary">SIMPAN</button></div>
                                </div>
                            </form>
                            </div>
                        </div>
