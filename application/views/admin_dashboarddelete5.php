                ...
                <tbody>
                    <tr><?php foreach ($competition as $cpt) : ?>
                        ...
                        <td class="text-center">
                            <a href="<?= base_url(); ?>index.php/adminController/dashboar_delete_data/<?= $cpt['id'] ?>/competition " class="badge badge-danger float-center" onclick="return confirm('Apakah anda yakin menghapus data ini?');" ?>hapus</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
