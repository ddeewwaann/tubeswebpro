                    ...
                    <div class="col-8">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="nav-item active">
                                ...
                                color: white;" href="<?php echo base_url('index.php/adminController/dashboard_delete5') ?>">COMPETITION</a>
                            </li>
                            </ul>
                    </div>
                </div>
            ...
            <table class="table mt-5">
                ...
                <tbody>
                    <tr><?php foreach ($competition as $cpt) : ?>
                        <td class="text-center"><?= $cpt['nama_game']; ?></td>
                        <td class="text-center"><?= $cpt['judul']; ?></td>
                        <td class="text-center"><?= $cpt['keterangan']; ?></td>
                        <td class="text-center"><?= $cpt['waktu']; ?></td>
                        <td class="text-center">
                            <a href="<?= base_url(); ?>index.php/adminController/dashboard_delete_data/<?= $cpt['id'] ?>/competition " class="badge badge-danger float-center" onclick="return confirm('Apakah anda yakin menghapus data ini?');" ?>hapus</a>
                            <a href="<?= base_url(); ?>index.php/adminController/dashboard_edit/competition/<?= $cpt['id'] ?>" class="badge badge-success float-center" ?>ubah</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
