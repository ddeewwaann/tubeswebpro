    ...
    <section>
                    ...
                    <div class="col-8">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="nav-item active">
                                ...
                                color: white;" href="<?php echo base_url('index.php/adminController/dashboard_delete3') ?>">UPDATE</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link news" href="<?php echo base_url('index.php/adminController/dashboard_delete4')?>">EVENT</a>
                            </li>
                            <li class="nav-item">
        ...
        <section>
            ...
            <table class="table mt-5">
                ...
                <tbody>
                    <tr><?php foreach ($updates as $upd) : ?>
                        <td class="text-center"><?= $upd['nama_game']; ?></td>
                        <td class="text-center"><?= $upd['judul']; ?></td>
                        <td class="text-center"><?= $upd['keterangan']; ?></td>
                        <td class="text-center"><?= $upd['waktu']; ?></td>
                        <td class="text-center">
                            <a href="<?= base_url(); ?>index.php/adminController/dashboard_delete_data/<?= $upd['id'] ?>/updates " class="badge badge-danger float-center" onclick="return confirm('Apakah anda yakin menghapus data ini?');" ?>hapus</a>
                            <a href="<?= base_url(); ?>index.php/adminController/dashboard_edit/updates/<?= $upd['id'] ?>" class="badge badge-success float-center" ?>ubah</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
