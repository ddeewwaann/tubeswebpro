                    ...
                    <div class="col-8">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="nav-item active">
                                ...
                                color: white;" href="<?php echo base_url('index.php/adminController/dashboard_delete2') ?>">NOTICE</a>
                            </li>
                            <li class="nav-item">
            ...
            <table class="table mt-5">
                ...
                <tbody>
                    <tr><?php foreach ($notice as $ntc) : ?>
                        <td class="text-center"><?= $ntc['nama_game']; ?></td>
                        <td class="text-center"><?= $ntc['judul']; ?></td>
                        <td class="text-center"><?= $ntc['keterangan']; ?></td>
                        <td class="text-center"><?= $ntc['waktu']; ?></td>
                        <td class="text-center">
                            <a href="<?= base_url(); ?>index.php/adminController/dashboard_delete_data/<?= $ntc['id'] ?>/notice " class="badge badge-danger float-center" onclick="return confirm('Apakah anda yakin menghapus data ini?');" ?>hapus</a>
                            <a href="<?= base_url(); ?>index.php/adminController/dashboard_edit/notice/<?= $ntc['id'] ?>" class="badge badge-success float-center" ?>ubah</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
