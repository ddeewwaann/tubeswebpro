                    ...
                    <div class="col-8">
                        <ul class="nav nav-tabs">
                            <li class="nav-item ">
                                ...
                                color: white;" href="<?php echo base_url('index.php/adminController/dashboard_delete') ?>">NEWS</a>
                            </li>
                            <li class="nav-item">
            ...
            <table class="table mt-5">
                ...
                <tbody>
                    <tr><?php foreach ($news as $nws) : ?>
                        <td class="text-center"><?= $nws['nama_game']; ?></td>
                        <td class="text-center"><?= $nws['judul']; ?></td>
